...
public class LeptonAuroraBlocks {
	...
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_SLAB = HELPER.createCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, "stripped_glowshroom_hyphae_slab", () -> new /*Alpha*/StrippedLogSlabBlock(LeptonProperties.STRIPPED_GLOWSHROOM_HYPHAE), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_STAIRS = HELPER.createCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, "stripped_glowshroom_hyphae_stairs", () -> new /*Alpha*/StrippedLogStairsBlock(Blocks.STRIPPED_OAK_WOOD.getDefaultState(), LeptonProperties.STRIPPED_GLOWSHROOM_HYPHAE), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_WALL = HELPER.createCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, "stripped_glowshroom_hyphae_wall", () -> new /*Alpha*/StrippedLogWallBlock(LeptonProperties.STRIPPED_GLOWSHROOM_HYPHAE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> STRIPPED_GLOWSHROOM_HYPHAE_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, LeptonMods.QUARK, "stripped_glowshroom_hyphae_vertical_slab", () -> new /*Alpha*/StrippedLogVerticalSlabBlock(LeptonProperties.STRIPPED_GLOWSHROOM_HYPHAE), ItemGroup.BUILDING_BLOCKS);
	
	public static final RegistryObject<Block> GLOWSHROOM_HYPHAE_SLAB = HELPER.createCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, "glowshroom_hyphae_slab", () -> new /*Alpha*/LogSlabBlock(STRIPPED_BROWN_MUSHROOM_HYPHAE_SLAB, LeptonProperties.GLOWSHROOM_HYPHAE), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> GLOWSHROOM_HYPHAE_STAIRS = HELPER.createCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, "glowshroom_hyphae_stairs", () -> new /*Alpha*/LogStairsBlock(STRIPPED_BROWN_MUSHROOM_HYPHAE_STAIRS, Blocks.OAK_WOOD.getDefaultState(), LeptonProperties.GLOWSHROOM_HYPHAE), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> GLOWSHROOM_HYPHAE_WALL = HELPER.createCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, "glowshroom_hyphae_wall", () -> new /*Alpha*/LogWallBlock(STRIPPED_BROWN_MUSHROOM_HYPHAE_WALL, LeptonProperties.GLOWSHROOM_HYPHAE), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> GLOWSHROOM_HYPHAE_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ENHANCED_MUSHROOMS, LeptonMods.QUARK, "glowshroom_hyphae_vertical_slab", () -> new /*Alpha*/LogVerticalSlabBlock(STRIPPED_BROWN_MUSHROOM_HYPHAE_VERTICAL_SLAB, LeptonProperties.GLOWSHROOM_HYPHAE), ItemGroup.BUILDING_BLOCKS);
