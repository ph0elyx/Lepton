...
public class LeptonAbnormalsBlocks {
	...
	public static final RegistryObject<Block> STRIPPED_ROSEWOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "stripped_rosewood_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_MORADO_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "stripped_morado_wood_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> MORADO_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "morado_wood_vertical_slab", () -> new LogVerticalSlabBlock(STRIPPED_MORADO_WOOD_VERTICAL_SLAB, Block.Properties.from(Blocks.OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_YUCCA_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "stripped_yucca_wood_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_KOUSA_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "stripped_kousa_wood_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_ASPEN_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "stripped_aspen_wood_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_GRIMWOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ATMOSPHERIC, LeptonMods.QUARK, "stripped_grimwood_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.STRIPPED_OAK_WOOD)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_MAPLE_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.AUTUMNITY, LeptonMods.QUARK, "stripped_maple_wood_vertical_slab", () -> new VerticalSlabBlock(Properties.STRIPPED_MAPLE_WOOD), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_POISE_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.ENDERGETIC_EXPANSION, LeptonMods.QUARK, "stripped_poise_wood_vertical_slab", () -> new VerticalSlabBlock(Properties.POISE_WOOD), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_DRIFTWOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.UPGRADE_AQUATIC, LeptonMods.QUARK, "stripped_driftwood_vertical_slab", () -> new VerticalSlabBlock(Properties.DRIFTWOOD), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> STRIPPED_RIVER_WOOD_VERTICAL_SLAB = HELPER.createTwoCompatBlock(LeptonMods.UPGRADE_AQUATIC, LeptonMods.QUARK, "stripped_river_wood_vertical_slab", () -> new VerticalSlabBlock(Properties.RIVER_WOOD), ItemGroup.BUILDING_BLOCKS);
