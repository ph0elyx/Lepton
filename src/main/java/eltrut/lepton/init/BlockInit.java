...
public class BlockInit {
	...
	// Cracked Sandstone
	public static final RegistryObject<Block> CRACKED_SANDSTONE = HELPER.createBlock("cracked_sandstone", () -> new Block(AbstractBlock.Properties.from(Blocks.SANDSTONE)), ItemGroup.BUILDING_BLOCKS); // Soul Sandstone
	public static final RegistryObject<Block> CRACKED_RED_SANDSTONE = HELPER.createBlock("cracked_red_sandstone", () -> new Block(AbstractBlock.Properties.from(Blocks.RED_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	
	public static final RegistryObject<Block> CRACKED_SANDSTONE_SLAB = Registry.slabMod(HELPER, AbstractBlock.Properties.from(Blocks.SANDSTONE), "cracked_sandstone_slab");
	public static final RegistryObject<Block> CRACKED_RED_SANDSTONE_SLAB = Registry.slabMod(HELPER, AbstractBlock.Properties.from(Blocks.RED_SANDSTONE), "cracked_red_sandstone_slab");
	public static final RegistryObject<Block> CRACKED_SANDSTONE_STAIRS = HELPER.createBlock("cracked_sandstone_stairs", () -> new AbnormalsStairsBlock(CRACKED_SANDSTONE.get().getDefaultState(), AbstractBlock.Properties.from(Blocks.SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CRACKED_RED_SANDSTONE_STAIRS = HELPER.createBlock("cracked_red_sandstone_stairs", () -> new AbnormalsStairsBlock(CRACKED_RED_SANDSTONE.get().getDefaultState(), AbstractBlock.Properties.from(Blocks.RED_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CRACKED_SANDSTONE_WALL = Registry.wallMod(HELPER, AbstractBlock.Properties.from(Blocks.SANDSTONE), "cracked_sandstone_wall");
	public static final RegistryObject<Block> CRACKED_RED_SANDSTONE_WALL = Registry.wallMod(HELPER, AbstractBlock.Properties.from(Blocks.RED_SANDSTONE), "cracked_red_sandstone_wall");
	
	// Vanilla Slabs
	public static final RegistryObject<Block> ACACIA_WOOD_SLAB = Registry.slab(HELPER, Blocks.ACACIA_WOOD, "acacia_wood_slab"); // Abnormals and Aurora woods
	...
	public static final RegistryObject<Block> CRACKED_NETHER_BRICK_SLAB = Registry.slab(HELPER, Blocks.CRACKED_STONE_BRICKS, "cracked_nether_brick_slab");
	public static final RegistryObject<Block> CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB = Registry.slab(HELPER, Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, "cracked_polished_blackstone_brick_slab");
	...
	public static final RegistryObject<Block> CRACKED_NETHER_BRICK_STAIRS = Registry.stairs(HELPER, Blocks.CRACKED_STONE_BRICKS, "cracked_nether_brick_stairs");
	public static final RegistryObject<Block> CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS = Registry.stairs(HELPER, Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, "cracked_polished_blackstone_brick_stairs");
	...
	public static final RegistryObject<Block> PURPUR_WALL = Registry.wall(HELPER, Blocks.PURPUR_BLOCK, "purpur_wall"); // Midori
	public static final RegistryObject<Block> QUARTZ_WALL = Registry.wall(HELPER, Blocks.QUARTZ_BLOCK, "quartz_wall"); // Biotite
	public static final RegistryObject<Block> SMOOTH_QUARTZ_WALL = Registry.wall(HELPER, Blocks.SMOOTH_QUARTZ, "smooth_quartz_wall"); // Smooth Biotite
	public static final RegistryObject<Block> POLISHED_ANDESITE_WALL = Registry.wall(HELPER, Blocks.POLISHED_ANDESITE, "polished_andesite_wall"); // Polished Jasper, Marble, Slate, Limestone & Voidstone
	...
	public static final RegistryObject<Block> PRISMARINE_BRICK_WALL = Registry.wall(HELPER, Blocks.PRISMARINE_BRICKS, "prismarine_brick_wall"); // Elder Prismarine Bricks
	public static final RegistryObject<Block> DARK_PRISMARINE_WALL = Registry.wall(HELPER, Blocks.DARK_PRISMARINE, "dark_prismarine_wall"); // Elder Dark Prismarine
	public static final RegistryObject<Block> CUT_SANDSTONE_WALL = Registry.wall(HELPER, Blocks.CUT_SANDSTONE, "cut_sandstone_wall"); // Cut Soul Sandstone
	...
	public static final RegistryObject<Block> SMOOTH_SANDSTONE_WALL = Registry.wall(HELPER, Blocks.SMOOTH_SANDSTONE, "smooth_sandstone_wall"); // Smooth Soul Sandstone
	...
	public static final RegistryObject<Block> QUARTZ_BRICK_WALL = Registry.wall(HELPER, Blocks.QUARTZ_BRICKS, "quartz_brick_wall"); // Biotite Bricks
	public static final RegistryObject<Block> CRACKED_NETHER_BRICK_WALL = Registry.wall(HELPER, Blocks.CRACKED_STONE_BRICKS, "cracked_nether_brick_wall");
	public static final RegistryObject<Block> CRACKED_POLISHED_BLACKSTONE_BRICK_WALL = Registry.wall(HELPER, Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, "cracked_polished_blackstone_brick_wall");
